...
namespace Serializer
{
    public partial class Serializer : Form
    {
        ...
        {
            string[] personEntries = Directory.GetFiles(@"C:\Users\viczmandni\Documents\visual studio 2015\Projects\Week15B_Projects\Serializer\bin\Debug", "*.dat");
            var p = Serialize.Deserializing(personEntries[0]);
            textBoxName.Text = 
        }
    }
}
